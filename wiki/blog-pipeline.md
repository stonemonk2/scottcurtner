...
| # | Title | URL | Date | Series |
|---|-------|-----|------|--------|
| 1 | How I Built a Professional Website for Free | scottcurtner.com/article-1.html | April 2026 | Tech Auditor Goes Deep |
...
| How I Set Up a Free Email Gate for My AI Setup Guide | Kit vs Beehiiv comparison, CAN-SPAM compliance, why DIY Gmail/Apps Script failed, full Beehiiv workflow | Medium |
...
| How to Audit Your Open Brain | Security/stability audit of Supabase setup. RLS verification, MCP security, data integrity. Auditor's angle. | Medium |
| How to Scale Your Open Brain | Adding targeted tables, prompt discipline, UI overlay concept, schema design principles. | Medium |
| How to Partner with Your AI to Develop Content Across Platforms | Claude as co-creator, Open Brain as content fodder, LinkedIn vs blog vs newsletter formats. | Medium |
| What is RAG, and What is My 2nd Brain MCP Server? | Plain-English RAG explainer tied to Open Brain. Non-technical audience. Full sourced draft available. | Medium |
| GitHub Desktop: Phase 2 of Building Your Site | ACTION FIRST: Scott must use GitHub Desktop for a real change first, then write from experience. | After action |
| How to Optimize Your Website for Google and Corporate Web Filters | SEO, favicon, sitemap, categorization submissions. ACTION FIRST: Monitor Search Console data. | After action |
...
1. **2nd Brain Installs** — each install = a story (Clarice, Cashton, Debbie, and beyond)
2. **Tech Auditor Goes Deep on AI Tools** — Open Brain, Claude, MCP, vibe coding
3. **Real Estate Investing** — bookkeeping, property management, GreatHome.us
4. **SBEF / Nonprofit Leadership** — community, civic engagement
5. **Technology Audit Observations** — GRC, audit methodology, career
6. **Custom Quicken Project** — personal finance automation
7. **Cloudflare / Website Migration** — domain management, DNS
8. **CIA Exam Prep** — study notes, process, credential pursuit
...
- Every "Tech Auditor Goes Deep" article includes a short **auditability section**
- Each 2nd Brain install generates: install → story → blog → LinkedIn article → LinkedIn post
- Cross-post candidates: scottcurtner.com articles → LinkedIn article → LinkedIn post
- GreatHome.us gets real estate content cross-posts

---

## Open Tasks

- [ ] Write Cashton blog article (get quote + photos first)
- [ ] Draft "How I Set Up a Free Email Gate" post
...
*To update: add new article ideas and milestones to Open Brain, then ask Claude to recompile.*
